...
module.exports = async function (fastify, opts) {
    fastify.post('/', {preValidation : [fastify.authenticate, fastify.roleSerialization]}, controller.create);
    ...
    fastify.put('/:_id', {preValidation : [fastify.authenticate, fastify.roleSerialization]}, controller.update);
